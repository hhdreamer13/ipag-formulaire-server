...
const EtudiantForm = () => {
  ...
  const schema = yup.object({
    domaineDoctorat: yup.string().required("Ce champ est obligatoire"),
    universite: yup.string().required("Ce champ est obligatoire"),
      ...
      >
        ...
        <div className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
          <div className=''>
            <InputField
              type='text'
              label='Inscrit en doctorat de'
              name='domaineDoctorat'
              register={register}
              placeholder='Droit'
              error={errors["domaineDoctorat"]?.message}
            />
          </div>
          <div className=''>
            <InputField
              type='text'
              label="À l'université de"
              name='universite'
              register={register}
              placeholder='Paris 2'
              error={errors["universite"]?.message}
            />
          </div>
          <div className=''>
            <InputField
              ...
              <table className='w-full divide-y divide-gray-200 table-auto text-sm'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='border px-4 py-2'>
                      Photocopie lisible de la carte d’étudiant de l’année
                      universitaire 2023-2024 avec la mention doctorat visible
                      ou le certificat de scolarité
                    </td>
                  </tr>
                  <tr>
                    <td className='border px-4 py-2'>5</td>
                    <td className='border px-4 py-2'>
                      Pour les doctorants-contractuels : autorisation de cumul
                    </td>
                  </tr>
                  <tr>
                    <td className='border px-4 py-2'>6</td>
                    <td className='border px-4 py-2'>
                      Pour les étudiants ressortissants d’un pays hors Union
                      européenne : photocopie couleur et lisible du titre de
                      séjour
                    </td>
                  </tr>
                </tbody>
