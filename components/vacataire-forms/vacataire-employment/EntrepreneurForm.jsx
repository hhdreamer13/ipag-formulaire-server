...
const EntrepreneurForm = () => {
  ...
  const schema = yup.object({
    domaineEntrepreneur: yup.string().required("Ce champ est obligatoire"),
  });
        ...
        <div className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
          <div className=''>
            <InputField
              ...
              name='domaineEntrepreneur'
              register={register}
              placeholder=''
              error={errors["corpsFonctionnaire"]?.message}
            />
          </div>
        </div>
          ...
          <div className='relative mt-4 bg-gray-50 rounded-xl overflow-hidden'>
              ...
              <table className='w-full divide-y divide-gray-200 table-auto text-sm'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='border px-4 py-2'>
                      Inscription INSEE de moins d’un an
                    </td>
                  </tr>
                  <tr>
                    <td className='border px-4 py-2'>5</td>
                    <td className='border px-4 py-2'>
                      Toutes pièces justifiant de la perception de revenus
                      professionnels réguliers depuis 3 ans (sous n’importe quel
                      statut si le statut d’auto-entrepreneur est récent)
                    </td>
                  </tr>
                  <tr>
            ...
            <ul>
              <li className='px-4 py-3 text-sm'>
                ...
                activité principale sur les 3 dernières années.
              </li>
            </ul>
